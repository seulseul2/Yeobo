...
for i in range(8):
    try: 
        ...
        response_area = requests.get(BASE_URL + path_area + queryString_area, verify=False)
        ...
        response_overview = requests.get(BASE_URL + path_overview + queryString_overview, verify=False)
